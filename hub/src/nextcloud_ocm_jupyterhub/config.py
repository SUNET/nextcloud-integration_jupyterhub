...
def apply_services_defaults(c) -> None:
    ...
    c.JupyterHub.services = [
        ...
        },
        {
            ...
            "command": [sys.executable, "-m", "nextcloud_ocm_jupyterhub.services.ocm"],
            ...
            # back-channel push is rejected with 401.
            "environment": {
                ...
                "NEXTCLOUD_DEBUG_OAUTH": os.environ.get("NEXTCLOUD_DEBUG_OAUTH", ""),
            },
        },
    ]
